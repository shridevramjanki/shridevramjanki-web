...
import { Calendar, Heart, Gift, Cake, Users, ArrowRight, Copy, Check, User, Home, PhoneIcon, Mail } from "lucide-react"
...
const pujaOptions = [
  {
    ...
    benefits: ["गौ पूजा और आरती", "प्रसाद वितरण", "गौ माताओं को विशेष आहार", "आशीर्वाद प्रमाण पत्र"],
    icon: <Cake className="h-5 w-5" />,
    image: "/images/puja/birthday-puja.jpg",
  },
  {
    id: "anniversary",
    ...
    benefits: ["दंपति के लिए विशेष पूजा", "गौ माताओं को खिलाना", "आशीर्वाद प्रमाण पत्र", "स्मृति चिन्ह"],
    icon: <Gift className="h-5 w-5" />,
    image: "/images/puja/anniversary-puja.jpg",
  },
  {
    id: "festival",
    title: "त्योहार पूजा",
    ...
    benefits: ["त्योहार विशेष पूजा", "गौ माताओं को विशेष आहार", "प्रसाद", "आशीर्वाद प्रमाण पत्र"],
    icon: <Calendar className="h-5 w-5" />,
    image: "/images/puja/festival-puja.jpg",
  },
  {
    id: "memorial",
    title: "स्मृति पूजा",
    ...
    benefits: ["शांति पाठ", "गौ दान", "पिंडदान", "श्राद्ध कर्म", "स्मृति प्रमाण पत्र"],
    icon: <Heart className="h-5 w-5" />,
    image: "/images/puja/memorial-puja.jpg",
  },
]
...
export default function PujaDonationSection() {
  const [selectedPujas, setSelectedPujas] = useState<{ [key: string]: boolean }>({})
  ...
  const sendPujaDetailsEmail = () => {
    ...
    console.log("Sending puja details email:", {
      ...
      body: `
        ...
        पूजा विवरण:
        ${selectedPujasList.length ? "चयनित पूजा: " + selectedPujasList.join(", ") : ""}
        ${selectedItemsList.length ? "अतिरिक्त सामग्री: " + selectedItemsList.join(", ") : ""}
  ...
  const hasSelections = Object.values(selectedPujas).some((v) => v) || Object.values(selectedItems).some((v) => v)

  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-br from-amber-50 to-white py-16 md:py-20">
      {/* Decorative Elements */}
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="mb-12 text-center">
          ...
          >
            विशेष अवसरों पर गौ पूजा करवाकर आशीर्वाद प्राप्त करें। जन्मदिन, वार्षिकोत्सव, या किसी भी शुभ अवसर पर गौ माता की पूजा
            करवाएं।
          </motion.p>
        </div>
              ...
              <div className="p-4">
                <div className="mb-3 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-amber-600">₹{option.amount}</span>
                  </div>
                  <Button
                    size="sm"
                ...
                <ul className="space-y-1">
                  ...
                  {option.benefits.length > 3 && (
                    <li className="text-sm text-amber-600">+ {option.benefits.length - 3} और लाभ</li>
                  )}
                </ul>
              </div>
            </motion.div>
        ...
        >
          <h3 className="mb-4 text-xl font-bold text-gray-900">अतिरिक्त पूजा सामग्री</h3>
          <p className="mb-6 text-gray-600">अपनी पूजा में अतिरिक्त सामग्री जोड़ें</p>
              ...
              >
                <CardContent className="p-4">
                  ...
                  <div className="mt-2 flex justify-end">
                    {selectedItems[item.id] && <span className="text-amber-600">चयनित ✓</span>}
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          >
            <div className="container mx-auto flex flex-col items-center justify-between gap-4 sm:flex-row">
              <div>
                ...
                <p className="text-2xl font-bold text-amber-600">₹{totalAmount}</p>
              </div>
              <Button
        ...
        <Dialog open={showSummaryDialog} onOpenChange={setShowSummaryDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>आपके द्वारा चुने गए पूजा विकल्पों का विवरण</DialogDescription>
            </DialogHeader>
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                <h4 className="font-medium">चयनित पूजा</h4>
                {Object.entries(selectedPujas).some(([_, selected]) => selected) ? (
              ...
              <div className="space-y-2">
                ...
                {Object.entries(selectedItems).some(([_, selected]) => selected) ? (
                  <ul className="space-y-2">
                  ...
                  <p className="text-gray-500">कोई अतिरिक्त सामग्री चयनित नहीं है</p>
                )}
              </div>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleProceedToUserDetails} className="bg-amber-600 hover:bg-amber-700">
                विवरण भरें
              </Button>
            </DialogFooter>
          </DialogContent>
        ...
        <Dialog open={showUserDetailsDialog} onOpenChange={setShowUserDetailsDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>पूजा बुकिंग प्रक्रिया को पूरा करने के लिए कृपया अपना विवरण भरें</DialogDescription>
            </DialogHeader>
            <div className="space-y-4 py-4">
              <div className="space-y-2">
              ...
              <div className="rounded-lg bg-amber-50 p-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-amber-800">
                    आपका विवरण और पूजा की जानकारी हमारे द्वारा संग्रहित की जाएगी और आपको पूजा की पुष्टि भेजने के लिए उपयोग की
                    जाएगी।
                  </p>
                </div>
              </div>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleUserDetailsSubmit} className="bg-amber-600 hover:bg-amber-700">
                भुगतान करें
              </Button>
            </DialogFooter>
          </DialogContent>
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-6 py-4">
              <div className="flex flex-col items-center justify-center space-y-4">
                <p className="text-lg font-medium text-amber-600">₹{totalAmount}</p>
        ...
        >
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <h3 className="mb-4 text-2xl font-bold">पूजा के बारे में अधिक जानकारी</h3>
              <p className="mb-4 text-amber-100">
                हमारी गौशाला में पूजा करवाने से आपको और आपके परिवार को गौ माता का विशेष आशीर्वाद मिलता है। सभी पूजाएँ वैदिक मंत्रोच्चार
                के साथ अनुभवी पंडितों द्वारा की जाती हैं।
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <Users className="h-5 w-5 flex-shrink-0" />
                  <span>आप और आपके परिवार के सदस्य पूजा में शामिल हो सकते हैं</span>
                </li>
                <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>आपका दान गौ माताओं के कल्याण के लिए उपयोग किया जाएगा</span>
                </li>
              </ul>
            </div>
            <div className="flex items-center justify-center">
              <div className="rounded-xl bg-white/10 p-6 backdrop-blur-sm">
                <h4 className="mb-3 text-center text-xl font-bold">विशेष अवसर पूजा</h4>
                <p className="mb-4 text-center text-amber-100">किसी भी विशेष अवसर के लिए कस्टम पूजा पैकेज भी उपलब्ध हैं</p>
                <Button
                  variant="outline"
